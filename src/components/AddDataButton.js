...
export default function AddDataButton(props) {
    ...
    const [oppClan, setOppClan] = useState("")
    const [oppRace, setOppRace] = useState(Race.TERRAN)
    const [oppNotes, setOppNotes] = useState("")

    const handleSetRace = (race) => {
        switch (race) {
            case "Terran": setOppRace(Race.TERRAN)
            break;
            case "Protoss": setOppRace(Race.PROTOSS)
            break;
            case "Zerg": setOppRace(Race.ZERG)
            break;
            case "Random": setOppRace(Race.RANDOM)
            break;
            default: break;
          }
    }
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form className="space-y-6" action="#" onSubmit={(event) => {
                                ...
                                <div>
                                    ...
                                    <input type="text" name="opp-clan" id="opp-clan" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" onChange={event => setOppClan(event.target.value)} placeholder="OIGE"/>
                                </div>
                                <div>
                                    <label for="opp-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name</label>
                                    <input type="text" name="opp-name" id="opp-name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Camelot" onChange={event => setOppName(event.target.value)} required/>
                                </div>
                                <div>
                                    <label for="opp-race" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Race</label>
                                    <select name="opp-race" id="opp-race" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" onChange={event => handleSetRace(event.target.value)} >
                                ...
                                <div>
                                    ...
                                    <input type="text" name="opp-notes" id="opp-notes" placeholder="Worst player ever" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" onChange={event => setOppNotes(event.target.value)} required/>
                                </div>
                                <button type="submit"
